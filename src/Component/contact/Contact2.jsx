    ...
    return (
        ...
        <section className=''>
            ...
            <div className='w-[90%] mx-auto banner pb-10 md:pb-20'>
                <h2 data-aos="fade-right" data-aos-delay="500" className="text-[#01ecff] text-2xl md:text-4xl md:w-96 mx-auto  lg:text-5xl  font-bold text-center  pt-10 md:pt-16">Contact  us</h2>
                    ...
                    <div className="container px-6 py-6 lg:py-12 mx-auto">
                        <div className="lg:flex lg:items-center lg:-mx-6">
                            ...
                            <div className="mt-6 space-y-8 md:mt-8">
                                ...
                                <img src="https://png.pngtree.com/png-vector/20231015/ourmid/pngtree-business-contract-3d-character-illustration-png-image_10163941.png" alt="" />
                            </div>
