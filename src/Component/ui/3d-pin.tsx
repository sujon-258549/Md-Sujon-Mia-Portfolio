...
export const PinContainer: React.FC<PinContainerProps> = ({
  ...
  const [transform, setTransform] = useState<string>("translate(-50%,-50%) rotateX(0deg)");
...
// Define types for the PinPerspective props
        ...
        >
          <>
            <motion.div
              ...
              className="absolute left-1/2 top-1/2 rounded-[50%] bg-sky-500/[0.08] shadow-[0_8px_16px_rgb(0_0_0/0.4)]"
            ></motion.div>
            <motion.div
              initial={{ opacity: 0, scale: 0, x: "-50%", y: "-50%" }}
              animate={{ opacity: [0, 1, 0.5, 0], scale: 1 }}
