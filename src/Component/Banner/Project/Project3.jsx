                        ...
                        <div className="py-5">
                            ...
                            <div className="col-md-4 col-md-offset-4 contents3">
                                <div className="screens3">
                                    <image src="/333.png" alt="Scrollable Content" />
                                </div>
                            </div>
                        </div>
                        <div />
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <div className="flex gap-2 justify-center">
                                ...
                                <div className="tooltip-container" >
                                    ...
                                    <div className="text">
                                        <a className="icon" href="https://github.com/sujon-258549/jobtask_pagination_client">
                                            <div className="layer">
                                                <span></span>
                                                <span></span>
                                                <span></span>
                                ...
                                <div className="tooltip-container" >
                                    ...
                                    <div className="text">
                                        <a className="icon" href="https://github.com/sujon-258549/jobtask_pagination_servire">
                                            <div className="layer">
                                                <span></span>
                                                <span></span>
                                                <span></span>
