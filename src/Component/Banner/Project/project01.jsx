                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <div className="flex gap-2 justify-center">
                                ...
                                <div className="tooltip-container" >
                                    <div className="tooltip">
                                        <div className="profile">
                                            ...
                                            <div className="text-white font-mono">GitHub Clink Site</div>
                                        </div>
                                    </div>
                                    <div className="text">
                                        <a className="icon" href="https://github.com/sujon-258549/inventory-management">
                                            <div className="layer">
                                                <span></span>
                                                <span></span>
                                                <span></span>
                                ...
                                <div className="tooltip-container" >
                                    ...
                                    <div className="text">
                                        <a className="icon" href="https://github.com/sujon-258549/inventory-management-service">
                                            <div className="layer">
                                                <span></span>
                                                <span></span>
                                                <span></span>
                                ...
                                <div className="tooltip-container" >
                                    ...
                                    <div className="text">
                                        <a className="icon" href="https://inventory-management-354ce.web.app/">
                                            <div className="layer">
                                                <span></span>
                                                <span></span>
                                                <span></span>
